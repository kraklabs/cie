...
- **Description:** HTTP URL for read queries. Edge Cache serves all read requests with low latency.
...
```yaml
cie:
  edge_cache: "http://localhost:8080"   # Local development
  # edge_cache: "https://cie-cache.example.com"  # Production
```
